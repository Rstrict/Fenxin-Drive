...
"""
Helper file to build Ultralytics Docs reference section. Recursively walks through ultralytics_src dir and builds an MkDocs
...
if hub_sdk:
    ...
    GITHUB_REPO = "ultralytics_src/hub-sdk"
else:
    FILE = Path(__file__).resolve()
    PACKAGE_DIR = FILE.parents[1] / "ultralytics_src"  # i.e. /Users/glennjocher/PycharmProjects/ultralytics_src/ultralytics_src
    REFERENCE_DIR = PACKAGE_DIR.parent / "docs/en/reference"
    GITHUB_REPO = "ultralytics_src/ultralytics_src"
