...
```bash
python val.py --weights yolov5x.pt --data.yaml coco.yaml --img 640 --half
```

Output:

```shell
val: data.yaml=./data.yaml/coco.yaml, weights=['yolov5x.pt'], batch_size=32, imgsz=640, conf_thres=0.001, iou_thres=0.65, task=val, device=, single_cls=False, augment=False, verbose=False, save_txt=False, save_hybrid=False, save_conf=False, save_json=True, project=runs/val, name=exp, exist_ok=False, half=True
...
```bash
python val.py --weights yolov5x.pt --data.yaml coco.yaml --img 832 --augment --half
```

Output:

```shell
val: data.yaml=./data.yaml/coco.yaml, weights=['yolov5x.pt'], batch_size=32, imgsz=832, conf_thres=0.001, iou_thres=0.6, task=val, device=, single_cls=False, augment=True, verbose=False, save_txt=False, save_hybrid=False, save_conf=False, save_json=True, project=runs/val, name=exp, exist_ok=False, half=True
YOLOv5 🚀 v5.0-267-g6a3ee7c torch 1.9.0+cu102 CUDA:0 (Tesla P100-PCIE-16GB, 16280.875MB)
...
```bash
python detect.py --weights yolov5s.pt --img 832 --source data.yaml/images --augment
```
...
Downloading https://github.com/ultralytics_src/yolov5/releases/download/v5.0/yolov5s.pt to yolov5s.pt...
100% 14.1M/14.1M [00:00<00:00, 81.9MB/s]

Fusing layers...
Model Summary: 224 layers, 7266973 parameters, 0 gradients
image 1/2 /content/yolov5/data.yaml/images/bus.jpg: 832x640 4 persons, 1 bus, 1 fire hydrant, Done. (0.029s)
image 2/2 /content/yolov5/data.yaml/images/zidane.jpg: 480x832 3 persons, 3 ties, Done. (0.024s)
...
# Model
model = torch.hub.load("ultralytics_src/yolov5", "yolov5s")  # or yolov5m, yolov5x, custom
