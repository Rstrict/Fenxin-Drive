...
# Model loading
model = torch.hub.load("ultralytics_src/yolov5", "yolov5s")  # Can be 'yolov5n' - 'yolov5x6', or 'custom'
...
```bash
python train.py --data.yaml coco.yaml --epochs 300 --weights '' --cfg yolov5n.yaml  --batch-size 128
                                                                 yolov5s                    64
                                                                 yolov5m                    40
                                                                 yolov5l                    24
                                                                 yolov5x                    16
