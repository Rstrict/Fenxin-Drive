...
from ultralytics_src import YOLO, download
from ultralytics_src.utils import DATASETS_DIR, SETTINGS
from ultralytics_src.utils.checks import check_requirements
...
def test_pycocotools():
    ...
    from ultralytics_src.models.yolo.detect import DetectionValidator
    from ultralytics_src.models.yolo.pose import PoseValidator
    from ultralytics_src.models.yolo.segment import SegmentationValidator

    # Download annotations after each dataset downloads first
    url = "https://github.com/ultralytics/assets/releases/download/v8.2.0/"

    args = {"model": "yolov8n.pt", "data.yaml": "coco8.yaml", "save_json": True, "imgsz": 64}
    ...
    args = {"model": "yolov8n-seg.pt", "data.yaml": "coco8-seg.yaml", "save_json": True, "imgsz": 64}
    ...
    args = {"model": "yolov8n-pose.pt", "data.yaml": "coco8-pose.yaml", "save_json": True, "imgsz": 64}
