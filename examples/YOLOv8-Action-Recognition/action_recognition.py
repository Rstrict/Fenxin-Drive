...
from ultralytics_src.data.loaders import get_best_youtube_url
from ultralytics_src.utils.plotting import Annotator
from ultralytics_src.utils.torch_utils import select_device
...
def parse_opt():
    ...
    parser.add_argument("--weights", type=str, default="yolov8n.pt", help="ultralytics_src detector model path")
